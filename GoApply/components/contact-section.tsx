      ...
      <div className="w-full h-full flex flex-col">
        ...
        <div className="grid grid-cols-5 gap-3 flex-1">
          ...
          <div className="col-span-4 bg-white/70 backdrop-blur-sm rounded-lg p-3 shadow-lg border border-white/50 flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-2 flex-1">
              <div>
                <Input 
              ...
              <div className="col-span-2">
                <Button 
                  type="submit" 
                  disabled={loading}
                  className="w-full bg-primary hover:bg-primary/90 text-white py-1.5 rounded-md font-semibold transition-all text-xs h-8"
                >
                  {loading ? 'Sending...' : success ? 'Message Sent!' : 'Start My Application Journey'}
                </Button>
              </div>
            </form>
          </div>
