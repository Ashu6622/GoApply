...
const getMenuItems = (applicationCount: number) => [
  { icon: Home, label: "Overview", href: "/dashboard" },
  { icon: Search, label: "Find Programs", href: "/dashboard/search" },
  { icon: BookOpen, label: "My Applications", href: "/dashboard/applications", badge: applicationCount > 0 ? applicationCount.toString() : undefined },
...
export default function DashboardSidebar({ collapsed, onToggle }: DashboardSidebarProps) {
  ...
  const menuItems = getMenuItems(applicationCount)
  return (
    <motion.aside
